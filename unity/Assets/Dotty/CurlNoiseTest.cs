...
public class CurlNoiseTest : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        int curlNoiseId = world.AddNoiseField(Dotty.World.NoiseType.SimplexCurl, 50f, 10.0f, true); 
        ...
        attractorId = world.AddAttractor(new Vector3(0, 0, 0), 10, 1f, 100000, Dotty.World.Falloff.Squared);
    }
